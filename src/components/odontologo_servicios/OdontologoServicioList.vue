...
<template>
  <Dialog v-model:visible="dialogVisible" header="Mis Servicios Asignados" :style="{ width: '60vw', maxWidth: '900px' }"
    modal @hide="$emit('close')">
    <div class="contenedor-lista">
      <!-- Campo de búsqueda -->
      <input v-model="nombreBusqueda" placeholder="Buscar servicio por nombre" class="busqueda" />

      <!-- Contenedor de tarjetas -->
      <div class="tarjetas-grid">
        <div v-for="servicio in serviciosFiltrados" :key="servicio.id" class="tarjeta-servicio">
          ...
          <!-- Botones de acción -->
          <div class="acciones">
            <Button icon="pi pi-trash" aria-label="Eliminar" class="boton-eliminar"
